...
attr_accessor :dealer_showing,
  ...
  def game_state
    if dealer_showing.length == 1 && dealer_showing.include?(value == 11)
    ...
    elsif dealer_showing.length == 1 && dealer_showing.include?(value == 10)
      self.output = "It's your lucky day! Not in this game, though. Definitely not that."
    elsif dealer_showing.length == 1 && dealer_showing.include?(value == 7..9)
    ...
    elsif dealer_showing.length == 1 && dealer_showing.include?(value == 4..6)
    ...
    elsif dealer_showing.length == 1 && dealer_showing.include?(value == 3)
